...
contract TornadoAuctionHandler {
    ...
    function initializeAuction(uint256 _auctionEndDate, uint96 _auctionedSellAmount, uint96 _minBuyAmount, uint256 _minBidPerOrder, uint256 _minFundingThreshold) external onlyGovernance {
	...
	IGovernanceDepositInterface(GovernanceAddress).depositEthereumForGasCompensations();
    }
}